...
- **`negative-near-miss-state-sync` FAIL** (sim=0.56): internal's renderer genuinely uses localStorage for some state, making this a false negative. Test case needs revision — threshold raised to 0.6 or case removed.
